...
export default function Editor({ raw, setRaw, setData, onParse, setError, onError }: any) {
  ...
  return (
    <div className="card p-2">
      ...
      <textarea
        className="w-full h-64 p-2 code-font bg-white dark:bg-gray-800 rounded border"
        value={local ?? ""}
        onChange={(e) => {
